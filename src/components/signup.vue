    ...
    <div class="container">
      ...
      <div class="login-content">
        <form action="index.html">
          ...
          <div @click='signup()' class="btn">Signup</div>
          <a @click='sendtologin()' class="login-ac">Click Here If You Already Have Account</a>
        </form>
      </div>
    </div>
  </body>
...
export default{
	...
	methods : {
		...
		signup(){
			axios.get(`/signup?username=${this.username}&password=${this.password}`).then((data) =>{
